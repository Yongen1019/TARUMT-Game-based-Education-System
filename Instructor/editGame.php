    ...
    <body>
        ...
        ?>
            ...
            <div class="sidebar">
                ...
                $gameID = $_GET['gameID'];
                ?>
                <a class="active" href="game.php?<?php echo"instructorID={$instructorID}&classID={$classID}&gameID={$gameID}";?>">Game - Question List</a>
            ...
            <div class="contentMiddle">
                ...
                <div class="titleBar">
                    ...
                    <p class="quizTotalScore">Total score: <?php echo"$totalScore";?></p>
                </div>
                    ...
                    <?php
                        ...
                        if($gameResult){
                            while ($row = $gameResult->fetch_assoc()){
                                ...
                                <a class="questionMenuBtn" href="deleteQuestion.php?<?php echo"instructorID={$instructorID}&classID={$classID}&gameID={$gameID}&questionID={$questionID}";?>">
                                <i style="font-size:24px;cursor:pointer;color: #541b1a;" class="fas">&#xf2ed;</i>
                                </a>
