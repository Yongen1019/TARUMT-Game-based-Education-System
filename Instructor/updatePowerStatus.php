                    ...
                    if($findPowerResult){
                        while ($row = $findPowerResult->fetch_assoc()){
                            ...
                            if(isset($_POST["update"])){
                                $updateQuery = "UPDATE GamePower 
                                        SET status = '$newStatus' WHERE gameID = '$gameID' and powerID = '$powerID'";
                                $updateResult = $con->query($updateQuery);
                                if($updateResult){
                                    echo"<script type='text/javascript'> 
                                    location.replace('powerStore.php
                                    ?instructorID={$instructorID}&classID={$classID}&gameID={$gameID}')
