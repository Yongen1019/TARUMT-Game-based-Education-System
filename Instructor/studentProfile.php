        ...
        ?>
            ...
            <div class="contentMiddle">
                <div class="userProfileFormContainer">
                    ...
                    ?>
                        <div class="upload">
                            <img class="userProfilePic" src="../Student/img/<?php echo$profilePicture;?>" 
                                 alt="<?php echo$profilePicture;?>" /><br>
                        </div>
                        ...
                        <div class="infoContainer">
                            ...
                            ?>
                            <p>
                                <i style="font-size:14px;font-weight: 800;color:#541b1a;" class="fa">&#xf003;</i> 
                                <?php echo $studentEmail; ?>
                            </p>
                            <div class="contactStudContainer">
                                <a href="mailto:<?php echo"$studentEmail";?>?
                                   Subject=An email from instructor(<?php echo$instructorName;?>)&
                                   body=Dear Student, ">
                                 contact student</a>
                            </div>
                        </div>
