        ...
        <div class="loginContent">
            ...
            <div class="loginFormContainer">
                ...
                function passwordMatch($password, $email){
                    ...
                    $query = "SELECT * FROM InstructorAccount 
                                WHERE password = '$password' AND email = '$email'";
                    $decryptQuery = "SELECT password FROM InstructorAccount
                                     WHERE email = '$email'";
                    ...
                    }else{ //if password changed by the user
                ...
                function errorDetect(){
                    ...
                    if($email == "tarumteducationinstructor@gmail.com" || emailExist($email) == true){
                ...
                if(isset($_POST["submit"])){
                    ...
                    if(empty($error) == TRUE || $email == "tarumteducationinstructor@gmail.com"){
                ...
                <form action="login.php" method="post" class="loginForm">
                    ...
                    <input id="showPwCheckBox" type="checkbox" onclick="showPassword()">
                    <span id="showPwTxt">Show Password</span>
                    <?php
