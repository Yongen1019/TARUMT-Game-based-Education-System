    ...
    <body>
        ...
        ?>
            ...
            <div class="sidebar">
                ...
                ?>
                <a class="active" href="userProfile.php?<?php echo"instructorID={$instructorID}";?>">User Profile</a>
            ...
            <div class="contentMiddle">
                <div class="userProfileFormContainer">
                    ...
                    if($result){
                        while($row = $result->fetch_assoc()){
                            $email = $row["email"];
                            $instructorName = ucwords($row["instructorName"]);
                    ...
                    ?>
                        ...
                        <div class="editBtnContainer">
                            <a id="editBtn" href="editUserProfile.php?<?php echo"instructorID={$instructorID}";?>">UPDATE PROFILE</a>
                        </div>
