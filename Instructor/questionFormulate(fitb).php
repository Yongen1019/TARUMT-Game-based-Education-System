...
<html>
    ...
    <body>
        ...
        function errorDetect(){
            ...
            }else if($answerTxt == null){
                $error = true;
                echo "<script>alert('Please provide an answer.');</script>";
            }
            
            if(strlen($questionTxt)>100){
                $error = true;
                echo "<script>alert('Question are too long, it cannot be more than 100 characters.');</script>";
            }else if(strlen($answerTxt)>50){
                $error = true;
                echo "<script>alert('Answer is too long, it cannot be more than 50 characters.');</script>";
            }
        ...
        if(isset($_POST["save"])){
            ...
            $answerTxt = ucfirst($_POST['answerTxt']);
            
            $_SESSION['FITBquestion'] = ucfirst($_POST['questionTxt']);
            ...
            if($error == false){
                ...
                $insertGameQuestionSql = "INSERT INTO Gamequestion (questionID, questionType, question, duration, scoreAwarded, pointEarned, gameID) VALUES 
                   ('$latestQuestionID', 'fill-in-the-blank question', '$questionTxt', '$duration', '$scoreAwarded', '$pointEarned', '$gameID')";   
                ...
                if($con->query($insertGameQuestionSql) == true){
                    ...
                    //answer sql query
                    $insertAnswerSql = "INSERT INTO AnswerOption(answerID, answerText, correctness, questionID) VALUES
                                                ('$latestAnswerID', '$answerTxt', '1', '$latestQuestionID')"; 
                    
                    if($con->query($insertAnswerSql) == true){
        ...
        <form method="post">
            ...
            <div>
                ...
                <div class="questionTxtArea">
                    <textarea style="resize:none" id="questionTxt" name="questionTxt" rows="8" cols="100" placeholder="please type your question here."><?php if(!empty($error)) echo $_SESSION['FITBquestion']?></textarea>
                    <div class="tooltip">
                ...
                <div class="answerTxtArea">
                    <label for="answerTxt">Mark an answer as correct, if the answer is exactly:</label> &nbsp;
                    <div class="tooltip_2">
                        <i style="font-size:25px; color: #541b1a;" class="fa">&#xf29c;</i>
                        <span class="tooltiptext_2">Answer must be exactly the same but ignoring the cases.</span>
                    </div>
                    <br>
                    <input type="text" id="answerTxt" name="answerTxt" placeholder="Please type the answer here."><br>
                </div>
            </div>
