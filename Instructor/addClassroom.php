            ...
            <div class="contentMiddle">
                ...
                if(isset($_POST["submit"])){
                    ...
                    if(empty($error) == TRUE){
                        ...
                        //sql query
                        $insertSql = "INSERT INTO Classroom (classID, className, classDescription,
                            classSubject, classCode, instructorID) VALUES 
                           ('$latestClassID', '$className', '$classDescription', 
                                '$classSubject', '$classCodeGen', '$instructorID')";                   
